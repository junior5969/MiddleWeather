...
exports.updateFavoriteSection = updateFavoriteSection;
exports.newSearch = newSearch;
const domUtils_1 = require("./domUtils");
const storage_1 = require("./storage");
//WEATHER
function renderWeather(data) {
    const weatherSection = document.getElementById("result");
    const weatherInnerSection = document.getElementById("inner-element");
    const iconUrl = (0, domUtils_1.getIconById)(data.weather[0].id);
    ...
    const wind = Math.round((0, domUtils_1.windSpeed)(data.wind.speed * 1.60934)); // Conversione da mph a km/h
    const today = data.dt;
...
function renderForecast(data) {
    const forecastInnerSection = document.getElementById("forecast");
    ...
    const forecastHTML = Object.entries(dailyMap)
        ...
        const resultTemp = Math.round((0, domUtils_1.averageTemp)(temps));
        const iconUrl = (0, domUtils_1.getIconById)(entries[0].weather[0].id);
